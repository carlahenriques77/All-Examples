...
while (i <= 5) {
  console.log(i);
  i++ // Dang. I didn't knew that... Looks like you have to put it BELOW the Console for it to... Register?????? Which doens't make too much sense to me. Didn't the JavaScript do the Commands from Up to Down???
}
...
for (let l = 1; l <= 10; l++) {
  console.log(`Esta é a ${l}ª vez que esta frase é exibida no console.`);
}
...
for (let x = 0; x <= cities.length; x++) {
  upperCaseCities // ??? Yes, I don't know how to make this still... Without a Visualization, it get's too Complicated to, as I have no idea what is happening.
}
