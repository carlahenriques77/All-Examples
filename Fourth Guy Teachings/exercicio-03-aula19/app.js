...
// let brazilianFoods = ["Coxinha", null, "brigadeiro"] wrong, surprisingly.
...
// let dogNames = maleDogNames + femaleDogNames wrong, it seems.
...
const initials01 = `${dogNames[0][0]}${dogNames[1][0]}${dogNames[2][0]}${dogNames[3][0]}` // Alternative

 // How to take only one Character from the Array, instead of a whole Word.

//console.log(initials)

//console.log(initials01)
