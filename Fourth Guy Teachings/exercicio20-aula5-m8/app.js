...
}, '') // The "\n" will make it break an line. I don't know if it can be used outside of the console, but if it can, and for some reason we can find a thing that might need it, then we can consider this command more
