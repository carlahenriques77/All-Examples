...
const my3FavoriteTVShows = ["Filme_01", "Filme_02", "Filme_03"]
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(", ").replace(", Filme_03", " e Filme_03")}.`
...
/*
  ...
  - This: Converta explicitamente este boolean em uma **string** ao inserí-lo na frase;
