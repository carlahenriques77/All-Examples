...
const cookedIngredients = ingredients.reduce((acc, item, index, array) => {
  const correctWordGender = /a$/.test(item) ? 'cozida' : 'cozido' // I *think* that this "?" and ":" means if and else, as he reffered to them this way. Maybe an useful shorthand? Probably not, as it might make it harder to understand overall
...
const peopleAmount = 
  topBrazilmovies
  .filet(movie => movie.distributedBy === 'Disney')
