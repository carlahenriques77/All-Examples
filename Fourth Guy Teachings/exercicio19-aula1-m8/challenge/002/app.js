...
buttonInitCounter.addEventListener('click', () => {
  timer = setInterval(() => {
    counterContainer.textContent = counter + 1 // ++counter
    counter++
  }, 1000)
}) // Bro, I hate when he does it in a way that doesn't even work properly... I know that it would be more complicated to do it fully, but... Dang, does teaching these techniques has any point if you won't also teach on how to fix them and make them work?
