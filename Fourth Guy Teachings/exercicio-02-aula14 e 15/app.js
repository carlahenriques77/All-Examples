...
console.log(myFavoriteTom) // Come back here later when you finish.
// Maybe we can find a solution that is better than this.
...
const number = 'programmingLanguage'

const number01 = number.length

const number02 = programmingLanguage.length // Alternative

console.log(number01)

console.log(number02)

console.log(programmingLanguage.length) //	 His Solution
...
const last = randomWord.length // ???

console.log(last)

console.log(randomWord[randomWord.length - 1]) // How he made that Challenge about using "length" to find the last Character of a Word.
...
console.log(summerMessage.toLowerCase()) // His Method. Seems better again, as he didn't have to add a Const to add these Attributes...
...
const winterMessage01 = winterMessage.toUpperCase()

console.log(winterMessage01)
...
const winterMessage02 = winterMessage.indexOf('v')

console.log(winterMessage02) 
...
const winterMessage03 = winterMessage.lastIndexOf('n')

console.log(winterMessage03) 
...
console.log(harryPotterAuthor[0] + harryPotterAuthor[1] + harryPotterAuthor[2] + harryPotterAuthor[3]) // ???

console.log(harryPotterAuthor.slice(0, 4)) // Oh, so that was what I was supposed to do... No wonder it looked a bit weird. Maybe if he hinted to Slice it, then I would have done it right... Also, IT'S "( )", NOT "[ ]".
...
console.log(bestMovie.replace("La la land", "Moonlight")) // Damn. Maybe he sould be more Specific on these, as doing it by just Reading is pretty... Complicated.
...
console.log(name[0].toUpperCase() + name.slice(1, 6) + ' ' + name[7].toUpperCase() + name.slice(8)) // Dang.
...
const name01 = 'walter white'

let newName01 = `${name[0].toUpperCase()}${name.slice(1, 6)} ${name[7].toUpperCase()}${name.slice(8)}`
