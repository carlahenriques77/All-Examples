...
randomNumbers.reverse() // Reverse an Array
...
crazyArray.shift() // Remove the first Item and then Return it
...
const zequinha = dogs.find(dog => dog.name === 'Zequinha') // Finds the Written Item
