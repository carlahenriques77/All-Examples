...
function functionIntiateAnimalSlide() {
  ...
  class classSlide {
    ...
    if (this.anyDist.movement > 120 && this.propertySlideIndex.propertyNext !== undefined) {

      this.methodActiveNextSlide()

    }

    else if (this.anyDist.movement < -120 && this.propertySlideIndex.propertyPrev !== undefined) {
  ...
  methodSlideIndexNav(propertySlideIndex) {
    ...
    this.propertySlideIndex = {
      ...
      propertyNext: propertySlideIndex === constLast ? undefined : propertySlideIndex + 1,
  ...
  methodChangeActiveClass() {
    ...
    this.propertySlideArray.forEach(parameterSlideArray => parameterSlideArray.anyChangeActiveElement.classList.remove(this.anyChangeActiveElement))

    this.propertySlideArray[this.propertySlideIndex.propertyActive].anyChangeActiveElement.classList.add(this.anyActiveSlide)

  }

  methodActivePrevSlide() {
    
    if (this.propertySlideIndex.propertyPrev !== undefined) this.methodChangeSlide(this.propertySlideIndex.propertyPrev)

  }

  methodActiveNextSlide() {

    if (this.propertySlideIndex.propertyNext !== undefined) this.methodChangeSlide(this.propertySlideIndex.propertyNext)
  ...
  methodBindEvents() {
    ...
    this.methodOnResize = functionDebounce(this.methodOnResize.bind(this), 200)
